...
class PersonalityProvider(BaseProvider):
    ...
    async def get_context_prompt(self, user_text: str = "") -> str:
        ...
        instruction = (
            ...
            "Обновляй субличность только если появилась принципиально новая информация, "
            "которой там ещё нет — новый факт, изменение позиции, неожиданный поворот. "
            "Не обновляй если содержимое уже отражает суть, просто другими словами. "
            "Перед обновлением сверься с текущим содержимым — если информация уже есть, пропусти.\n\n"
