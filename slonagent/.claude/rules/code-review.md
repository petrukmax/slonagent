...
## Не сериализуй данные без причины
...
## Не добавляй параметры без смысла

Если значение всегда одно — захардкоди. Не создавай параметр "на всякий случай".

## Импорты только наверху файла
